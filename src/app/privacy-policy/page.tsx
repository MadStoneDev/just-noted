    ...
    <>
      ...
      <div className={`pt-3`}>
        ...
        >
          ...
          <p>
            We built <span className={`font-medium`}>JustNoted</span> with
            privacy as a core principle. Our goal is to provide a
            distraction-free note-taking experience without compromising your
            privacy.
          </p>
          ...
          <p>
            ...
            any personal information about you. We don't ask for your name,
            email address, or any other identifiable information to use our
            service.
          </p>
          <p>
            When you create notes, they are associated with a randomly generated
            anonymous token stored only in your browser's LocalStorage. We have
            no way to connect this token to you personally.
          </p>
          <p>
            We do not track or store information about your device, browser
            type, operating system, or IP address in relation to your notes or
          ...
          <p>
            ...
            through your browser using the anonymous token created for you. We
            do not read, analyze, or process your note content.
          </p>
          <p>
            When you delete a note, it is permanently deleted from our servers.
            We do not keep backups of deleted notes.
          </p>
          <p>
          ...
          <p>
            ...
            us improve our service. This data includes information about how
            visitors use our site, such as the pages they visit and how long
            they stay.
          </p>
          <p>
          ...
          <p>
            ...
            anonymous token. We do not use tracking cookies or third-party
          ...
          <p>
            ...
            we'll revise the "Last updated" date at the top of this page. We
