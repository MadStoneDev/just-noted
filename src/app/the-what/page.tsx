...
export default async function TheWhatPage() {
    ...
    <>
      ...
      <main className={`mt-2 flex-grow w-full overflow-hidden`}>
        <div className={`pt-3 sm:text-center`}>
          ...
          >
            <p>
              I could probably summarise everything below with this one
              sentence: <span className={`font-medium`}>JustNoted</span> is my
            ...
            <p>
              I created <span className={`font-medium`}>JustNoted</span> because
              I was constantly frustrated with the lack of simple note-taking
              options out there. Hear me out, I know there are a million and one
              different note-taking apps and websites but not like what I was
              looking for. I wanted something that just works – you visit the
              page and immediately start typing. No messing around with logins,
              no waiting for pages to load, none of that stuff that gets in the
              way when you just need to write something down quickly.
            </p>
            <p>
            ...
            <p>
              <span className={`font-medium`}>JustNoted</span> came out of a
              genuine every day need. I couldn't access notepad on all my
              devices, but I constantly needed somewhere to quickly type phone
              numbers, temporary passwords, or notes while on calls. I needed a
              space to brainstorm ideas or draft social media posts without
              committing them to permanent storage somewhere. I just wanted a
              place where my thoughts could live temporarily until I was ready
              to move them elsewhere or delete them.
            </p>
            <p>
              I looked everywhere for something this straightforward that
              wouldn't force me to create an account or pay for features I
            ...
            <p>
              ...
              email and let me know your ideas. I would love for this project to
              serve as many people as possible while remaining simple and
              intuitive 🙌.
            </p>
          </section>
        </div>
