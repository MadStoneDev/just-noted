      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input
            type="number"
            id="targetCount"
            className="w-full p-2 border border-[var(--color-border-primary)] rounded-[var(--radius-lg)] focus:ring-[var(--color-accent)] focus:border-[var(--color-accent)] focus:outline-none"
            value={targetValue}
        ...
        <div className="flex justify-between pt-2">
          <button
            ...
            className="px-4 py-2 border border-[var(--color-border-primary)] text-[var(--color-text-primary)] rounded-[var(--radius-lg)] hover:bg-[var(--color-bg-tertiary)] transition-all duration-200"
          >
            Clear Goal
          </button>
          <button
    ...
    <button
      ...
      className={`px-4 py-2 text-sm font-medium ${
        ...
        isActive
          ...
          : "bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] border-[var(--color-border-primary)] hover:bg-[var(--color-bg-tertiary)]"
      }`}
    >
