...
function ActionButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`group flex items-center gap-1.5 p-1.5 text-[var(--color-text-secondary)] rounded-[var(--radius-md)] transition-colors ${hoverColor} disabled:opacity-50 disabled:cursor-not-allowed`}
      title={title || label}
      disabled={disabled}
    >
      {icon}
    ...
    <span className="ml-2 px-2 py-0.5 text-xs rounded-full flex items-center gap-1">
      {isRedis ? (
        <>
          ...
          <span className="bg-[var(--color-warning-subtle)] text-[var(--color-warning)] px-1 rounded-sm">
            Local
          </span>
        </>
      ) : (
        <>
          ...
          <span className="bg-[var(--color-success-subtle)] text-[var(--color-success)] px-1 rounded-sm">
            Cloud
          </span>
        </>
      )}
...
function ConfirmModal({
  ...
  const colorClasses =
    variant === "danger"
      ...
      : "bg-[var(--color-warning)] hover:bg-[var(--color-warning)]";
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-[var(--color-bg-overlay)] z-50">
      <div className="bg-[var(--color-bg-primary)] rounded-[var(--radius-lg)] p-4 w-full max-w-md">
        ...
        <div className="flex justify-end space-x-2">
          <button
            onClick={onCancel}
            className="px-3 py-1.5 text-[var(--color-text-primary)] border border-[var(--color-border-primary)] rounded-[var(--radius-md)] hover:bg-[var(--color-bg-secondary)] transition-colors"
          ...
          <button
            onClick={onConfirm}
            className={`px-3 py-1.5 text-white rounded-[var(--radius-md)] flex items-center transition-colors ${colorClasses} disabled:opacity-50`}
            disabled={isProcessing}
          >
            {isProcessing && (
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-accent)] border border-[var(--color-border-primary)] rounded-[var(--radius-md)] hover:border-[var(--color-accent)] transition-colors"
        >
          <IconRefresh size={16} />
          Refresh
        </button>
        ...
        {sharedNotes.map((note) => (
          ...
          >
            ...
            <div className="mt-4 flex items-center text-sm flex-wrap gap-3">
              <div
                className={`flex items-center px-3 py-1.5 rounded-[var(--radius-md)] ${
                  note.isPublic
              ...
              <div className="flex items-center text-[var(--color-text-secondary)] bg-[var(--color-bg-secondary)] px-3 py-1.5 rounded-[var(--radius-md)]">
              ...
              <div className="mt-4 border-t pt-4">
                ...
                <ul className="space-y-2">
                  {note.sharedUsers.map((username) => (
                    <li
                      key={username}
                      className="flex items-center justify-between text-sm bg-[var(--color-bg-secondary)] px-3 py-2 rounded-[var(--radius-md)] hover:bg-[var(--color-hover)] transition-colors"
                    >
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-[var(--color-bg-overlay)] z-50">
          <div className="bg-[var(--color-bg-primary)] rounded-[var(--radius-lg)] p-4 w-full max-w-md">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-[var(--color-border-primary)] rounded-[var(--radius-md)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] focus:border-transparent mb-4"
              disabled={isProcessing}
              onKeyDown={(e) => {
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-[var(--color-accent)] text-white rounded-[var(--radius-md)] hover:bg-[var(--color-accent)]/90 transition-colors flex items-center disabled:opacity-50"
